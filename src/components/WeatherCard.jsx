...
export default function WeatherCard() {
  ...
  const getDescription = (description) => {
    switch (description) {
      case "clear sky":
        return "Clear skies ahead. Great day to go outside.";
      case "few clouds":
        return "A few clouds but mostly sunny. Enjoy the day.";
      case "scattered clouds":
        return "Scattered clouds around. Pleasant weather overall.";
      case "broken clouds":
        return "Mostly cloudy skies. Keep a jacket handy.";
      case "overcast clouds":
        return "Completely overcast. Dull day ahead.";
      case "light rain":
        return "Light rain expected. Carry an umbrella.";
      case "moderate rain":
        return "Moderate rain. Better to stay indoors.";
      case "heavy intensity rain":
        return "Heavy rain warning. Avoid unnecessary travel.";
      case "thunderstorm":
        return "Thunderstorm warning. Stay indoors if possible.";
      case "light snow":
        return "Light snowfall expected. Drive carefully.";
      case "heavy snow":
        return "Heavy snowfall. Stay warm and avoid roads.";
      case "mist":
        return "Misty conditions. Visibility may be reduced.";
      case "haze":
        return "Visibility is low due to haze. Consider wearing a mask.";
      case "fog":
        return "Dense fog ahead. Drive slowly and use fog lights.";
      case "dust":
        return "Dusty conditions. Keep windows closed.";
      case "smoke":
        return "Smoky air. Avoid outdoor activities.";
      case "drizzle":
        return "Light drizzle. A raincoat should do.";
      case "squalls":
        return "Sudden squalls expected. Secure loose objects outside.";
      default:
        return "Stay updated with the latest weather conditions.";
    }
  };
    ...
    return (
      <article className="flex flex-col rounded-[1.75rem] border border-black/10 bg-white/40 p-6 shadow-2xl shadow-orange-900/10 backdrop-blur-2xl dark:border-white/10 dark:bg-white/5 dark:shadow-black/60 sm:p-8">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-[clamp(1.15rem,3vw,1.50rem)] font-semibold">
  ...
  return (
    <article
      className={`flex-1 flex-col rounded-[1.75rem] border border-black/10 bg-white/40 p-6 shadow-2xl shadow-orange-900/10 backdrop-blur-2xl dark:border-white/10 dark:bg-white/5 dark:shadow-black/60 sm:p-8 ${weather ? "flex" : "hidden"}`}
    >
